            ...
            <div className="max-w-4xl mx-auto">
                ...
                >
                    <div className="flex items-center gap-4 mb-8">
                        ...
                        <div>
                            <h1 className="text-3xl font-bold text-slate-900">Client Rating Settings</h1>
                            <p className="text-slate-500">Manage the global "Client Rating" displayed on the landing page.</p>
                        </div>
                    </div>
                    ...
                    <form onSubmit={handleSubmit} className="space-y-8">
                        <div>
                            ...
                            <p className="mt-2 text-slate-400 text-sm italic">
                                This value represents the overall rating from our clients.
                            </p>
                        </div>
...
export default ClientRatingAdmin;
